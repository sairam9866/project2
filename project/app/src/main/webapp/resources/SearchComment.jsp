...
<form action="/app/SearchComment" method="GET">
    <div class="bg-img">
        <div class=" a container" style="text-align: center">
         <a href="login.jsp"class="logout" style="float:right">Log Out</a>
            <h1>
                Want to find a comment?<br> Search here!!
            </h1>
            <br>

            <br>
            <input type="text" class=" b form-group" style="width:400px" placeholder="Enter Commentid for comments to be searched"name="C_id"><br>
            <br>
	...
	CommentDAOImpl cImpl = new CommentDAOImpl();
		List<Comment> commentlist=(List<Comment>) request.getAttribute("list");
